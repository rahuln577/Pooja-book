            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
                    <div className="lg:col-span-3">
                        ...
                        <motion.h1 initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">{service.name}</motion.h1>
                    ...
                    {/* --- RESPONSIVE STICKY BEHAVIOR: sticky only on large screens (lg) and up --- */}
                    <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.4 }} className="bg-surface backdrop-blur-xl p-8 rounded-lg shadow-2xl lg:col-span-2 lg:sticky top-28 border border-primary/20">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                            <h2 className="text-3xl font-serif font-bold text-white mb-2 sm:mb-0">Book Homa</h2>
                        ...
                        <form onSubmit={handleSubmit}>
                            {/* Form remains the same, it's already responsive */}
