                ...
                >
                    ...
                    <Link to="/service-detail">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="mt-8 bg-primary text-background font-bold py-3 px-8 rounded-full text-lg shadow-xl hover:bg-opacity-90 transition"
                        >
                ...
                <section className="py-20 bg-transparent">
                    <div className="container mx-auto px-6">
                        <motion.h2
                            ...
                            className="text-3xl md:text-4xl font-serif font-bold text-center text-white mb-12"
                        >
                            Our Sacred Offering
                        </motion.h2>
                ...
                <section className="py-20 bg-surface/70 backdrop-blur-xl">
                    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.7 }}
                        >
                            <h2 className="text-3xl font-serif font-bold text-white mb-4">Significance of Pratyangira Devi</h2>
                            <p className="text-text-dark leading-relaxed">{homaService.significance}</p>
                        </motion.div>
                    </div>
                </section>
             )}
